...
<section id="contact" class="contact bg-light py-0 my-0">
    <div class="container bg-white py-5">
        <div class="mb-5">
            ...
            <iframe src="https://maps.google.com/maps?q=25.654069,89.834179&z=16&output=embed" width="100%" height="450" style="border:0; border-radius:8px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
</section>
